"""
As-is download script from https://github.com/carpedm20/DCGAN-tensorflow/blob/master/download.py
Which is a modification of https://github.com/stanfordnlp/treelstm/blob/master/scripts/download.py
